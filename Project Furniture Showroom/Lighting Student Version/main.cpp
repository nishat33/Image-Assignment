...
glm::vec3 pointLightPositions[] = {
    glm::vec3(-6.5f+3.5f,  4.50f,  -6.5+0.25f),
    //glm::vec3(1.5f,  4.5f,  -6.5 + 0.25f),
    glm::vec3(3.5f,  4.5f,   -6.5 + 0.25f),
    //glm::vec3(-1.5f,  4.5f,  -6.5 + 0.25f),
};
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
       ...
       //here the model matrix is the alTogether matrix
        ...
        scaleMatrix = glm::scale(identityMatrix, glm::vec3(.75, 0.75, 1.0));
        model = model * scaleMatrix;
        coffeTable(cubeVAO, lightingShader, model);
        ...
        //{
            ...
            model = glm::scale(model, glm::vec3(0.2f,0.2f,0.2f)); // Make it a smaller cube
            ...
            model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f)); // Make it a smaller cube
            ourShader.setMat4("model", model);
            ourShader.setVec3("color", glm::vec3(0.0f, 1.0f, 1.0f));
            glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, 0);
